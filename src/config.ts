...
export const defaultNetworks: Record<string, {rpc: string, schemaId?: string, easContract?: string, easSchemaContract?: string}> = {
  ...
  'optimism-goerli': {rpc: 'https://goerli.optimism.io', schemaId: '0x6b6de91bce95783621684871c48c45840dfff92520adf7786fc3ff649bd4e0a1', easContract: "0x4200000000000000000000000000000000000021", easSchemaContract: "0x4200000000000000000000000000000000000020"},
