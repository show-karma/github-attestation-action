...
export const defaultNetworks: Record<string, {rpc: string, schemaId?: string, easContract?: string, easSchemaContract?: string}> = {
  ...
  'optimism-goerli': {rpc: 'https://goerli.optimism.io', schemaId: '0x8512c8274fe29c264eace1bd3e65b3b17e94e507d68e1d28bf1e4f0c6d4bae61', easContract: "0x4200000000000000000000000000000000000021", easSchemaContract: "0x4200000000000000000000000000000000000020"},
